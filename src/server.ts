...
import routineMasterRoutes from './routes/routineMaster.routes';
...
import mealMasterRoutes from './routes/mealMaster.routes';
...
server.use("/api/meal-masters", mealMasterRoutes);
...
server.use("/api/routine-masters", routineMasterRoutes);
